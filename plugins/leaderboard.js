...
export default { name: 'leaderboard', version: '17.0.0', aliases: ['lb', 'top'], usage: 'leaderboard', help: 'Papan peringkat seluruh user', async execute({ m, prefix }) {
