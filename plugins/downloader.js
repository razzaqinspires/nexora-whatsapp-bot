...
export const handlers={
 download:{name:'download',version:'15.0.3',aliases:['dl'],usage:'download <url>',help:'Downloader universal via yt-dlp',execute:c=>send({...c,label:'DOWNLOAD'})},
 ytdl:{name:'ytdl',version:'15.0.3',usage:'ytdl <url>',help:'YouTube/general video downloader',execute:c=>send({...c,label:'YTDL'})},
 play:{name:'play',version:'15.0.3',usage:'play <query>',help:'Cari dan ambil video pertama',execute:c=>send({...c,search:true,label:'PLAY'})},
 ttdl:{name:'ttdl',version:'15.0.3',usage:'ttdl <url>',help:'TikTok downloader',execute:c=>send({...c,label:'TTDL'})},
 igdl:{name:'igdl',version:'15.0.3',usage:'igdl <url>',help:'Instagram downloader',execute:c=>send({...c,label:'IGDL'})},
 fbdl:{name:'fbdl',version:'15.0.3',usage:'fbdl <url>',help:'Facebook downloader',execute:c=>send({...c,label:'FBDL'})},
 ytmp3:{name:'ytmp3',version:'15.0.3',usage:'ytmp3 <url/query>',help:'Ambil audio MP3',execute:c=>send({...c,audio:true,search:true,label:'YTMP3'})}
};
